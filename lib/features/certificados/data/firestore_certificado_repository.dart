...
part 'firestore_certificado_repository.g.dart';

@riverpod
FirestoreCertificadoRepository firestoreCertificadoRepository(
  FirestoreCertificadoRepositoryRef ref,
  String uid,
) {
  return FirestoreCertificadoRepository(
    uid,
